      ...
      <div className="hidden lg:block bg-primary text-primary-foreground py-1.5 text-[12.5px] font-medium border-b border-primary/10">
        <div className="max-w-[1440px] mx-auto px-8 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <Link href="/about" className="hover:underline hover:font-bold hover:underline-offset-4 transition-all duration-500">Giới thiệu</Link>
            <Link href="/wholesale" className="hover:underline hover:font-bold hover:underline-offset-4 transition-all duration-500">Chính sách Đại lý</Link>
            <Link href="/blog" className="hover:underline hover:font-bold hover:underline-offset-4 transition-all duration-500">Tin tức</Link>
            <Link href="/contact" className="hover:underline hover:font-bold hover:underline-offset-4 transition-all duration-500">Liên hệ</Link>
          </div>
        </div>
      </div>

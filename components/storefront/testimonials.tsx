...
const ReviewCard = ({ review }: { review: ReviewProps }) => (
  <div className="w-[350px] md:w-[420px] h-full flex flex-col flex-shrink-0  mx-3 p-6 rounded-3xl bg-white/40 dark:bg-zinc-900/40 backdrop-blur-xl border border-white/40 dark:border-white/10 shadow-[0_8px_30px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.2)] relative overflow-hidden group hover:border-2 hover:border-primary transition-all duration-300">
    ...
    <div className="absolute -top-4 -right-4 text-primary/10 dark:text-primary/5 rotate-12 group-hover:scale-110 transition-transform duration-500">
      <Quote size={80} />
    </div>
    ...
    <div className="flex items-center gap-4 mb-4 relative z-10">
      <div className="relative">
        ...
        <div className="absolute -bottom-1 -right-1 bg-background rounded-full p-[2px]">
          <BadgeCheck className="w-4 h-4 text-green-500 fill-green-100 dark:fill-green-900/30" />
        </div>
      </div>
      <div>
    ...
    <div className="mt-auto flex items-center gap-2.5 p-2 rounded-xl bg-muted/50 border border-border/50 relative z-10 group-hover:bg-primary/5 group-hover:border-primary/20 transition-colors cursor-pointer">
...
export function TestimonialsSection({ testimonials }: { testimonials: ReviewProps[] }) {
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10 mb-12 relative z-10">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-foreground">
            Khách hàng nói <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-400">về chúng tôi</span>
          </h2>
      ...
      <div className="relative w-full flex overflow-hidden py-4 -mx-4 px-4 sm:mx-0 sm:px-0 group">
        ...
        {/* First Set */}
        <div className="flex shrink-0 animate-marquee group-hover:hover-pause">
        ...
        <div className="flex shrink-0 animate-marquee group-hover:hover-pause" aria-hidden="true">
          {testimonials.map((review, idx) => (
